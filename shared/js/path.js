...
const AppPath = (() => {
  ...
  const TOPICS = [
    ...
    { id: 'health',       level: 'A2', emoji: '🩺', label: 'Salud y Cuerpo',           labelEn: 'Health & Body',        order: 12  },
    { id: 'directions',   level: 'A2', emoji: '🧭', label: 'Direcciones y Lugares',    labelEn: 'Directions & Places',  order: 13  },
    { id: 'restaurant',   level: 'A1', emoji: '🍽️', label: 'Restaurante',              labelEn: 'Restaurant',           order: 8 },
    { id: 'supermarket',  level: 'A2', emoji: '🛒', label: 'Supermercado',             labelEn: 'Supermarket',          order: 16 },
    { id: 'transportation', level: 'A2', emoji: '🚌', label: 'Transporte',               labelEn: 'Transportation',       order: 18 },
    { id: 'airport',      level: 'A2', emoji: '✈️', label: 'Aeropuerto',               labelEn: 'Airport',              order: 19 },
    { id: 'accommodation', level: 'A2', emoji: '🏨', label: 'Alojamiento',              labelEn: 'Accommodation',        order: 20 },
    { id: 'kitchen',      level: 'A2', emoji: '🍳', label: 'Cocina',                   labelEn: 'Kitchen',              order: 17 },
    { id: 'movies',       level: 'A2', emoji: '🎬', label: 'Películas & Series',       labelEn: 'Movies & Series',      order: 21 },
    { id: 'music',        level: 'A2', emoji: '🎵', label: 'Música',                   labelEn: 'Music',                order: 22 },
    { id: 'technology',   level: 'B1', emoji: '💻', label: 'Tecnología',               labelEn: 'Technology',           order: 24 },
    { id: 'gym',          level: 'B1', emoji: '💪', label: 'Gimnasio',                 labelEn: 'Gym',                  order: 25 },
    { id: 'museums',      level: 'A2', emoji: '🖼️', label: 'Museos & Arte',            labelEn: 'Museums & Art',        order: 23 },
    { id: 'theater',      level: 'B1', emoji: '🎭', label: 'Teatro',                   labelEn: 'Theater',              order: 26 },
    ...
    { id: 'naturaleza_lugares', level: 'A2', emoji: '🏞️', label: 'Naturaleza y lugares',            labelEn: 'Nature & Places',         order: 14 },
    { id: 'conversacion', level: 'A2', emoji: '💬', label: 'Conversación y opiniones',            labelEn: 'Conversation & Opinions',         order: 10 },
  ];
