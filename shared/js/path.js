...
const AppPath = (() => {
  ...
  const TOPICS = [
    ...
    { id: 'family',                 level: 'A1', emoji: '👪', label: 'Familia',                    labelEn: 'Family',                     order: 6 },
    { id: 'emociones',              level: 'A1', emoji: '😊', label: 'Emociones',                  labelEn: 'Emotions',                   order: 7 },
    { id: 'daily_routine',          level: 'A1', emoji: '🕐', label: 'Rutina Diaria',              labelEn: 'Daily Routine',              order: 4 },
    { id: 'cotidianidad',           level: 'A2', emoji: '📅', label: 'Cotidianidad',               labelEn: 'Everyday Life',              order: 13 },
    { id: 'survival',               level: 'A1', emoji: '🆘', label: 'Sobrevivir el Idioma',       labelEn: 'Language Survival',          order: 2 },
    { id: 'weather',                level: 'A1', emoji: '🌤️', label: 'Clima',                      labelEn: 'Weather',                    order: 11 },
    { id: 'restaurant',             level: 'A1', emoji: '🍽️', label: 'Restaurante',                labelEn: 'Restaurant',                 order: 10 },
    { id: 'descripciones',          level: 'A2', emoji: '🔍', label: 'Descripciones',              labelEn: 'Descriptions',               order: 15 },
    { id: 'describiendo_personas',  level: 'A2', emoji: '🧑', label: 'Describiendo Personas',      labelEn: 'Describing People',          order: 16 },
    { id: 'profesiones',            level: 'A2', emoji: '👔', label: 'Profesiones',                labelEn: 'Professions',                order: 29 },
    { id: 'estudios',               level: 'A2', emoji: '🎓', label: 'Educación',                  labelEn: 'Education',                  order: 30 },
    { id: 'conversacion',           level: 'A2', emoji: '💬', label: 'Comunicación',               labelEn: 'Communication',              order: 12 },
    { id: 'pensamientos_opiniones', level: 'A2', emoji: '🧠', label: 'Pensamientos y Opiniones',   labelEn: 'Thoughts & Opinions',        order: 17 },
    { id: 'planes',                 level: 'A2', emoji: '🎯', label: 'Decisiones',                 labelEn: 'Decisions',                  order: 18 },
    { id: 'viajes',                 level: 'A2', emoji: '🧳', label: 'Viajes',                     labelEn: 'Travel',                     order: 26 },
    { id: 'directions',             level: 'A2', emoji: '🧭', label: 'Direcciones',                labelEn: 'Directions',                 order: 24 },
    { id: 'sitios',                 level: 'A2', emoji: '📍', label: 'Lugares',                    labelEn: 'Places',                     order: 25 },
    { id: 'vestimenta',           level: 'A1', emoji: '👕', label: 'Ropa',                      labelEn: 'Clothes',                   order: 9 },
    { id: 'hogar',                level: 'A1', emoji: '🏡', label: 'Hogar',                     labelEn: 'Home',                      order: 8 },
    { id: 'calendario',           level: 'A1', emoji: '🗓️', label: 'La Hora y la Fecha',        labelEn: 'Time & Date',               order: 5 },
    { id: 'emergencias',          level: 'A2', emoji: '🚨', label: 'Emergencias',               labelEn: 'Emergencies',               order: 14 },
    { id: 'naturaleza_lugares',     level: 'A2', emoji: '🏞️', label: 'Naturaleza',                 labelEn: 'Nature',                     order: 36 },
    ...
    { id: 'kitchen',                level: 'A2', emoji: '🍳', label: 'Cocina',                     labelEn: 'Kitchen',                    order: 22 },
    { id: 'transportation',         level: 'A2', emoji: '🚌', label: 'Transporte',                 labelEn: 'Transportation',             order: 23 },
    { id: 'airport',                level: 'A2', emoji: '✈️', label: 'Aeropuerto',                 labelEn: 'Airport',                    order: 27 },
    { id: 'accommodation',          level: 'A2', emoji: '🏨', label: 'Alojamiento',                labelEn: 'Accommodation',              order: 28 },
    { id: 'movies',                 level: 'A2', emoji: '🎬', label: 'Películas & Series',         labelEn: 'Movies & Series',            order: 33 },
    { id: 'music',                  level: 'A2', emoji: '🎵', label: 'Música',                     labelEn: 'Music',                      order: 34 },
    { id: 'museums',                level: 'A2', emoji: '🖼️', label: 'Museos & Arte',              labelEn: 'Museums & Art',              order: 35 },
    { id: 'economia',               level: 'B1', emoji: '💰', label: 'Economía',                   labelEn: 'Economy',                    order: 40 },
    { id: 'oficina',                level: 'B1', emoji: '💼', label: 'Oficina',                    labelEn: 'Office',                     order: 39 },
    { id: 'politica',               level: 'B1', emoji: '🏛️', label: 'Política',                   labelEn: 'Politics',                   order: 42 },
    { id: 'technology',             level: 'B1', emoji: '💻', label: 'Tecnología',                 labelEn: 'Technology',                 order: 38 },
    { id: 'gym',                    level: 'B1', emoji: '💪', label: 'Gimnasio',                   labelEn: 'Gym',                        order: 41 },
    { id: 'theater',                level: 'B1', emoji: '🎭', label: 'Teatro',                     labelEn: 'Theater',                    order: 43 },
