...
const AppPath = (() => {
  ...
  const TOPICS = [
    ...
    { id: 'personal_info',          level: 'A1', emoji: '🪪', label: 'Información Personal',       labelEn: 'Personal Information',       order: 3 },
    { id: 'family',                 level: 'A1', emoji: '👪', label: 'Familia',                    labelEn: 'Family',                     order: 5 },
    { id: 'emociones',              level: 'A1', emoji: '😊', label: 'Emociones',                  labelEn: 'Emotions',                   order: 6 },
    { id: 'daily_routine',          level: 'A1', emoji: '🕐', label: 'Rutina Diaria',              labelEn: 'Daily Routine',              order: 4 },
    { id: 'cotidianidad',           level: 'A2', emoji: '📅', label: 'Cotidianidad',               labelEn: 'Everyday Life',              order: 10 },
    { id: 'survival',               level: 'A1', emoji: '🆘', label: 'Sobrevivir el Idioma',       labelEn: 'Language Survival',          order: 2 },
    { id: 'weather',                level: 'A1', emoji: '🌤️', label: 'Clima',                      labelEn: 'Weather',                    order: 8 },
    { id: 'restaurant',             level: 'A1', emoji: '🍽️', label: 'Restaurante',                labelEn: 'Restaurant',                 order: 7 },
    { id: 'descripciones',          level: 'A2', emoji: '🔍', label: 'Descripciones',              labelEn: 'Descriptions',               order: 11 },
    { id: 'describiendo_personas',  level: 'A2', emoji: '🧑', label: 'Describiendo Personas',      labelEn: 'Describing People',          order: 12 },
    { id: 'profesiones',            level: 'A2', emoji: '👔', label: 'Profesiones',                labelEn: 'Professions',                order: 25 },
    { id: 'estudios',               level: 'A2', emoji: '🎓', label: 'Educación',                  labelEn: 'Education',                  order: 26 },
    { id: 'conversacion',           level: 'A2', emoji: '💬', label: 'Comunicación',               labelEn: 'Communication',              order: 9 },
    { id: 'pensamientos_opiniones', level: 'A2', emoji: '🧠', label: 'Pensamientos y Opiniones',   labelEn: 'Thoughts & Opinions',        order: 13 },
    { id: 'planes',                 level: 'A2', emoji: '🎯', label: 'Decisiones',                 labelEn: 'Decisions',                  order: 14 },
    { id: 'viajes',                 level: 'A2', emoji: '🧳', label: 'Viajes',                     labelEn: 'Travel',                     order: 22 },
    { id: 'directions',             level: 'A2', emoji: '🧭', label: 'Direcciones',                labelEn: 'Directions',                 order: 20 },
    { id: 'sitios',                 level: 'A2', emoji: '📍', label: 'Lugares',                    labelEn: 'Places',                     order: 21 },
    { id: 'naturaleza_lugares',     level: 'A2', emoji: '🏞️', label: 'Naturaleza',                 labelEn: 'Nature',                     order: 32 },
    { id: 'animales',               level: 'A2', emoji: '🐾', label: 'Animales',                   labelEn: 'Animals',                    order: 33 },
    { id: 'deportes',               level: 'A2', emoji: '⚽', label: 'Deportes',                   labelEn: 'Sports',                     order: 28 },
    { id: 'tiempo_libre',           level: 'A2', emoji: '🎨', label: 'Pasatiempos',                labelEn: 'Hobbies',                    order: 27 },
    { id: 'health',                 level: 'A2', emoji: '🩺', label: 'Salud',                      labelEn: 'Health',                     order: 15 },
    { id: 'cuerpo',                 level: 'A2', emoji: '🦵', label: 'Cuerpo',                     labelEn: 'Body',                       order: 16 },
    { id: 'supermarket',            level: 'A2', emoji: '🛒', label: 'Supermercado',               labelEn: 'Supermarket',                order: 17 },
    { id: 'kitchen',                level: 'A2', emoji: '🍳', label: 'Cocina',                     labelEn: 'Kitchen',                    order: 18 },
    { id: 'transportation',         level: 'A2', emoji: '🚌', label: 'Transporte',                 labelEn: 'Transportation',             order: 19 },
    { id: 'airport',                level: 'A2', emoji: '✈️', label: 'Aeropuerto',                 labelEn: 'Airport',                    order: 23 },
    { id: 'accommodation',          level: 'A2', emoji: '🏨', label: 'Alojamiento',                labelEn: 'Accommodation',              order: 24 },
    { id: 'movies',                 level: 'A2', emoji: '🎬', label: 'Películas & Series',         labelEn: 'Movies & Series',            order: 29 },
    { id: 'music',                  level: 'A2', emoji: '🎵', label: 'Música',                     labelEn: 'Music',                      order: 30 },
    { id: 'museums',                level: 'A2', emoji: '🖼️', label: 'Museos & Arte',              labelEn: 'Museums & Art',              order: 31 },
    { id: 'economia',               level: 'B1', emoji: '💰', label: 'Economía',                   labelEn: 'Economy',                    order: 36 },
    { id: 'oficina',                level: 'B1', emoji: '💼', label: 'Oficina',                    labelEn: 'Office',                     order: 35 },
    { id: 'politica',               level: 'B1', emoji: '🏛️', label: 'Política',                   labelEn: 'Politics',                   order: 38 },
    { id: 'technology',             level: 'B1', emoji: '💻', label: 'Tecnología',                 labelEn: 'Technology',                 order: 34 },
    { id: 'gym',                    level: 'B1', emoji: '💪', label: 'Gimnasio',                   labelEn: 'Gym',                        order: 37 },
    { id: 'theater',                level: 'B1', emoji: '🎭', label: 'Teatro',                     labelEn: 'Theater',                    order: 39 },
    { id: 'accountability',         level: 'B2', emoji: '📊', label: 'Contabilidad',               labelEn: 'Accounting',                 order: 40 },
  ];
