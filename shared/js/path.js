...
const AppPath = (() => {
  ...
  const TOPICS = [
    ...
    { id: 'survival',     level: 'A1', emoji: '🆘', label: 'Sobrevivir el Idioma',     labelEn: 'Language Survival',    order: 6  },
    { id: 'weather',      level: 'A1', emoji: '🌤️', label: 'Clima',                    labelEn: 'Weather',              order: 7  },
    { id: 'restaurant',   level: 'A1', emoji: '🍽️', label: 'Restaurante',              labelEn: 'Restaurant',           order: 8 },
    { id: 'descripciones', level: 'A2', emoji: '🔍', label: 'Descripciones',            labelEn: 'Descriptions',         order: 9 },
    { id: 'describiendo_personas', level: 'A2', emoji: '🧑', label: 'Describiendo Personas', labelEn: 'Describing People', order: 10 },
    { id: 'profesiones',  level: 'A2', emoji: '👔', label: 'Profesiones',              labelEn: 'Professions',          order: 11 },
    { id: 'conversacion', level: 'A2', emoji: '💬', label: 'Conversación y opiniones', labelEn: 'Conversation & Opinions', order: 12 },
    { id: 'planes',       level: 'A2', emoji: '🎯', label: 'Planes y decisiones',      labelEn: 'Plans & Decisions',    order: 13 },
    { id: 'directions',   level: 'A2', emoji: '🧭', label: 'Direcciones',              labelEn: 'Directions',           order: 14  },
    { id: 'sitios',       level: 'A2', emoji: '📍', label: 'Lugares',                  labelEn: 'Places',               order: 15 },
    { id: 'naturaleza_lugares', level: 'A2', emoji: '🏞️', label: 'Naturaleza',         labelEn: 'Nature',               order: 16 },
    { id: 'tiempo_libre', level: 'A2', emoji: '🎉', label: 'Tiempo Libre',             labelEn: 'Leisure',              order: 17 },
    { id: 'health',       level: 'A2', emoji: '🩺', label: 'Salud y Cuerpo',           labelEn: 'Health & Body',        order: 18  },
    { id: 'supermarket',  level: 'A2', emoji: '🛒', label: 'Supermercado',             labelEn: 'Supermarket',          order: 19 },
    { id: 'kitchen',      level: 'A2', emoji: '🍳', label: 'Cocina',                   labelEn: 'Kitchen',              order: 20 },
    { id: 'transportation', level: 'A2', emoji: '🚌', label: 'Transporte',               labelEn: 'Transportation',       order: 21 },
    { id: 'airport',      level: 'A2', emoji: '✈️', label: 'Aeropuerto',               labelEn: 'Airport',              order: 22 },
    { id: 'accommodation', level: 'A2', emoji: '🏨', label: 'Alojamiento',              labelEn: 'Accommodation',        order: 23 },
    { id: 'movies',       level: 'A2', emoji: '🎬', label: 'Películas & Series',       labelEn: 'Movies & Series',      order: 24 },
    { id: 'music',        level: 'A2', emoji: '🎵', label: 'Música',                   labelEn: 'Music',                order: 25 },
    { id: 'museums',      level: 'A2', emoji: '🖼️', label: 'Museos & Arte',            labelEn: 'Museums & Art',        order: 26 },
    { id: 'economia',     level: 'B1', emoji: '💰', label: 'Economía',                 labelEn: 'Economy',              order: 27 },
    { id: 'oficina',      level: 'B1', emoji: '💼', label: 'Oficina',                  labelEn: 'Office',               order: 28 },
    { id: 'technology',   level: 'B1', emoji: '💻', label: 'Tecnología',               labelEn: 'Technology',           order: 29 },
    { id: 'gym',          level: 'B1', emoji: '💪', label: 'Gimnasio',                 labelEn: 'Gym',                  order: 30 },
    { id: 'theater',      level: 'B1', emoji: '🎭', label: 'Teatro',                   labelEn: 'Theater',              order: 31 },
    { id: 'conceptos',    level: 'B1', emoji: '💭', label: 'Ideas y conceptos',        labelEn: 'Ideas & Concepts',     order: 32 },
    { id: 'accountability', level: 'B2', emoji: '📊', label: 'Contabilidad',             labelEn: 'Accounting',           order: 33 },
  ];
