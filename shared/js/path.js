...
const AppPath = (() => {
  ...
  const TOPICS = [
    ...
    { id: 'health',       level: 'A2', emoji: '🩺', label: 'Salud y Cuerpo',           labelEn: 'Health & Body',        order: 8  },
    { id: 'directions',   level: 'A2', emoji: '🧭', label: 'Direcciones y Lugares',    labelEn: 'Directions & Places',  order: 9  },
    { id: 'restaurant',   level: 'A1', emoji: '🍽️', label: 'Restaurante',              labelEn: 'Restaurant',           order: 10 },
    { id: 'supermarket',  level: 'A2', emoji: '🛒', label: 'Supermercado',             labelEn: 'Supermarket',          order: 11 },
    { id: 'transportation', level: 'A2', emoji: '🚌', label: 'Transporte',               labelEn: 'Transportation',       order: 12 },
    { id: 'airport',      level: 'A2', emoji: '✈️', label: 'Aeropuerto',               labelEn: 'Airport',              order: 13 },
    { id: 'accommodation', level: 'A2', emoji: '🏨', label: 'Alojamiento',              labelEn: 'Accommodation',        order: 14 },
    { id: 'kitchen',      level: 'A2', emoji: '🍳', label: 'Cocina',                   labelEn: 'Kitchen',              order: 15 },
    { id: 'movies',       level: 'A2', emoji: '🎬', label: 'Películas & Series',       labelEn: 'Movies & Series',      order: 16 },
    { id: 'music',        level: 'A2', emoji: '🎵', label: 'Música',                   labelEn: 'Music',                order: 17 },
    { id: 'technology',   level: 'B1', emoji: '💻', label: 'Tecnología',               labelEn: 'Technology',           order: 18 },
    { id: 'gym',          level: 'B1', emoji: '💪', label: 'Gimnasio',                 labelEn: 'Gym',                  order: 19 },
    { id: 'museums',      level: 'A2', emoji: '🖼️', label: 'Museos & Arte',            labelEn: 'Museums & Art',        order: 20 },
    ...
    { id: 'conceptos', level: 'B1', emoji: '💭', label: 'Ideas y conceptos',            labelEn: 'Ideas & Concepts',         order: 30 },
    { id: 'sociedad_actualidad', level: 'B1', emoji: '📰', label: 'Sociedad y actualidad',            labelEn: 'Society & Current Affairs',         order: 29 },
    { id: 'trabajo_economia', level: 'B1', emoji: '💼', label: 'Trabajo y economía',            labelEn: 'Work & Economy',         order: 28 },
    { id: 'planes', level: 'A2', emoji: '🎯', label: 'Planes y decisiones',            labelEn: 'Plans & Decisions',         order: 25 },
