...
const AppTopics = (() => {
  ...
  const _DEFAULT_RECORDS = [
    ...
    { id: 'describiendo_personas', label: 'Describiendo Personas',     labelEn: 'Describing People',         emoji: '🧑', phrase: true,  vocab: false, level: 'A2', order: 10 },
    { id: 'profesiones',           label: 'Profesiones',               labelEn: 'Professions',               emoji: '👔', phrase: true,  vocab: false, level: 'A2', order: 11 },
    { id: 'conversacion',          label: 'Conversación y opiniones',  labelEn: 'Conversation & Opinions',   emoji: '💬', phrase: true,  vocab: false, level: 'A2', order: 12 },
    { id: 'planes',                label: 'Planes y decisiones',       labelEn: 'Plans & Decisions',         emoji: '🎯', phrase: true,  vocab: false, level: 'A2', order: 13 },
    { id: 'directions',            label: 'Direcciones',               labelEn: 'Directions',                emoji: '🧭', phrase: true,  vocab: false, level: 'A2', order: 14 },
    { id: 'sitios',                label: 'Lugares',                   labelEn: 'Places',                    emoji: '📍', phrase: true,  vocab: false, level: 'A2', order: 15 },
    { id: 'naturaleza_lugares',    label: 'Naturaleza',                labelEn: 'Nature',                    emoji: '🏞️', phrase: true,  vocab: false, level: 'A2', order: 16 },
    { id: 'tiempo_libre',          label: 'Tiempo Libre',              labelEn: 'Leisure',                   emoji: '🎉', phrase: true,  vocab: false, level: 'A2', order: 17 },
    { id: 'health',                label: 'Salud y Cuerpo',            labelEn: 'Health & Body',             emoji: '🩺', phrase: true,  vocab: true, level: 'A2', order: 18 },
    { id: 'supermarket',           label: 'Supermercado',              labelEn: 'Supermarket',               emoji: '🛒', phrase: true,  vocab: true, level: 'A2', order: 19 },
    { id: 'kitchen',               label: 'Cocina',                    labelEn: 'Kitchen',                   emoji: '🍳', phrase: true,  vocab: true, level: 'A2', order: 20 },
    { id: 'transportation',        label: 'Transporte',                labelEn: 'Transportation',            emoji: '🚌', phrase: true,  vocab: true, level: 'A2', order: 21 },
    { id: 'airport',               label: 'Aeropuerto',                labelEn: 'Airport',                   emoji: '✈️', phrase: true,  vocab: true, level: 'A2', order: 22 },
    { id: 'accommodation',         label: 'Alojamiento',               labelEn: 'Accommodation',             emoji: '🏨', phrase: true,  vocab: true, level: 'A2', order: 23 },
    { id: 'movies',                label: 'Películas & Series',        labelEn: 'Movies & Series',           emoji: '🎬', phrase: true,  vocab: true, level: 'A2', order: 24 },
    { id: 'music',                 label: 'Música',                    labelEn: 'Music',                     emoji: '🎵', phrase: true,  vocab: true, level: 'A2', order: 25 },
    { id: 'museums',               label: 'Museos & Arte',             labelEn: 'Museums & Art',             emoji: '🖼️', phrase: true,  vocab: true, level: 'A2', order: 26 },
    { id: 'economia',              label: 'Economía',                  labelEn: 'Economy',                   emoji: '💰', phrase: true,  vocab: false, level: 'B1', order: 27 },
    { id: 'oficina',               label: 'Oficina',                   labelEn: 'Office',                    emoji: '💼', phrase: true,  vocab: false, level: 'B1', order: 28 },
    { id: 'technology',            label: 'Tecnología',                labelEn: 'Technology',                emoji: '💻', phrase: true,  vocab: true, level: 'B1', order: 29 },
    { id: 'gym',                   label: 'Gimnasio',                  labelEn: 'Gym',                       emoji: '💪', phrase: true,  vocab: true, level: 'B1', order: 30 },
    { id: 'theater',               label: 'Teatro',                    labelEn: 'Theater',                   emoji: '🎭', phrase: true,  vocab: true, level: 'B1', order: 31 },
    { id: 'conceptos',             label: 'Ideas y conceptos',         labelEn: 'Ideas & Concepts',          emoji: '💭', phrase: true,  vocab: false, level: 'B1', order: 32 },
    { id: 'accountability',        label: 'Contabilidad',              labelEn: 'Accounting',                emoji: '📊', phrase: true,  vocab: true, level: 'B2', order: 33 },
