...
const AppTopics = (() => {
  ...
  const _DEFAULT_RECORDS = [
    ...
    { id: 'verbos',         label: 'Verbos',                labelEn: 'Verbs',                emoji: '🏃', phrase: false, vocab: true,  vocabOrder: 2 },
    { id: 'adjetivos',      label: 'Adjetivos',             labelEn: 'Adjectives',           emoji: '🔤', phrase: false, vocab: true,  vocabOrder: 3 },
    { id: 'colores',        label: 'Colores',               labelEn: 'Colors',               emoji: '🎨', phrase: false, vocab: true,  vocabOrder: 4 },
    { id: 'naturaleza',     label: 'Naturaleza',            labelEn: 'Nature',               emoji: '🌳', phrase: false, vocab: true,  vocabOrder: 5 },
    { id: 'ropa',           label: 'Ropa y Moda',           labelEn: 'Clothing & Fashion',   emoji: '👕', phrase: false, vocab: true,  vocabOrder: 6 },
    { id: 'lengua',         label: 'Lengua y Comunicación', labelEn: 'Language & Communication', emoji: '🗣️', phrase: false, vocab: true, vocabOrder: 7 },
  ];
