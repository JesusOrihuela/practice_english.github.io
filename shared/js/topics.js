...
const AppTopics = (() => {
  ...
  const _DEFAULT_RECORDS = [
    ...
    { id: 'family',                 label: 'Familia',                    labelEn: 'Family',                     emoji: '👪', phrase: true,  vocab: true, level: 'A1', order: 5 },
    { id: 'emociones',              label: 'Emociones',                  labelEn: 'Emotions',                   emoji: '😊', phrase: true,  vocab: true, level: 'A1', order: 6 },
    { id: 'daily_routine',          label: 'Rutina Diaria',              labelEn: 'Daily Routine',              emoji: '🕐', phrase: true,  vocab: false, level: 'A1', order: 4 },
    { id: 'cotidianidad',           label: 'Cotidianidad',               labelEn: 'Everyday Life',              emoji: '📅', phrase: true,  vocab: false, level: 'A2', order: 10 },
    ...
    { id: 'restaurant',             label: 'Restaurante',                labelEn: 'Restaurant',                 emoji: '🍽️', phrase: true,  vocab: true, level: 'A1', order: 7 },
    { id: 'descripciones',          label: 'Descripciones',              labelEn: 'Descriptions',               emoji: '🔍', phrase: true,  vocab: false, level: 'A2', order: 11 },
    { id: 'describiendo_personas',  label: 'Describiendo Personas',      labelEn: 'Describing People',          emoji: '🧑', phrase: true,  vocab: false, level: 'A2', order: 12 },
    { id: 'profesiones',            label: 'Profesiones',                labelEn: 'Professions',                emoji: '👔', phrase: true,  vocab: false, level: 'A2', order: 25 },
    { id: 'estudios',               label: 'Educación',                  labelEn: 'Education',                  emoji: '🎓', phrase: true,  vocab: false, level: 'A2', order: 26 },
    { id: 'conversacion',           label: 'Comunicación',               labelEn: 'Communication',              emoji: '💬', phrase: true,  vocab: false, level: 'A2', order: 9 },
    { id: 'pensamientos_opiniones', label: 'Pensamientos y Opiniones',   labelEn: 'Thoughts & Opinions',        emoji: '🧠', phrase: true,  vocab: false, level: 'A2', order: 13 },
    { id: 'planes',                 label: 'Decisiones',                 labelEn: 'Decisions',                  emoji: '🎯', phrase: true,  vocab: false, level: 'A2', order: 14 },
    { id: 'viajes',                 label: 'Viajes',                     labelEn: 'Travel',                     emoji: '🧳', phrase: true,  vocab: false, level: 'A2', order: 22 },
    { id: 'directions',             label: 'Direcciones',                labelEn: 'Directions',                 emoji: '🧭', phrase: true,  vocab: false, level: 'A2', order: 20 },
    { id: 'sitios',                 label: 'Lugares',                    labelEn: 'Places',                     emoji: '📍', phrase: true,  vocab: false, level: 'A2', order: 21 },
    { id: 'naturaleza_lugares',     label: 'Naturaleza',                 labelEn: 'Nature',                     emoji: '🏞️', phrase: true,  vocab: false, level: 'A2', order: 32 },
    { id: 'animales',               label: 'Animales',                   labelEn: 'Animals',                    emoji: '🐾', phrase: true,  vocab: false, level: 'A2', order: 33 },
    { id: 'deportes',               label: 'Deportes',                   labelEn: 'Sports',                     emoji: '⚽', phrase: true,  vocab: false, level: 'A2', order: 28 },
    { id: 'tiempo_libre',           label: 'Pasatiempos',                labelEn: 'Hobbies',                    emoji: '🎨', phrase: true,  vocab: false, level: 'A2', order: 27 },
    { id: 'health',                 label: 'Salud',                      labelEn: 'Health',                     emoji: '🩺', phrase: true,  vocab: true, level: 'A2', order: 15 },
    { id: 'cuerpo',                 label: 'Cuerpo',                     labelEn: 'Body',                       emoji: '🦵', phrase: true,  vocab: false, level: 'A2', order: 16 },
    { id: 'supermarket',            label: 'Supermercado',               labelEn: 'Supermarket',                emoji: '🛒', phrase: true,  vocab: true, level: 'A2', order: 17 },
    { id: 'kitchen',                label: 'Cocina',                     labelEn: 'Kitchen',                    emoji: '🍳', phrase: true,  vocab: true, level: 'A2', order: 18 },
    { id: 'transportation',         label: 'Transporte',                 labelEn: 'Transportation',             emoji: '🚌', phrase: true,  vocab: true, level: 'A2', order: 19 },
    { id: 'airport',                label: 'Aeropuerto',                 labelEn: 'Airport',                    emoji: '✈️', phrase: true,  vocab: true, level: 'A2', order: 23 },
    { id: 'accommodation',          label: 'Alojamiento',                labelEn: 'Accommodation',              emoji: '🏨', phrase: true,  vocab: true, level: 'A2', order: 24 },
    { id: 'movies',                 label: 'Películas & Series',         labelEn: 'Movies & Series',            emoji: '🎬', phrase: true,  vocab: true, level: 'A2', order: 29 },
    { id: 'music',                  label: 'Música',                     labelEn: 'Music',                      emoji: '🎵', phrase: true,  vocab: true, level: 'A2', order: 30 },
    { id: 'museums',                label: 'Museos & Arte',              labelEn: 'Museums & Art',              emoji: '🖼️', phrase: true,  vocab: true, level: 'A2', order: 31 },
    { id: 'economia',               label: 'Economía',                   labelEn: 'Economy',                    emoji: '💰', phrase: true,  vocab: false, level: 'B1', order: 36 },
    { id: 'oficina',                label: 'Oficina',                    labelEn: 'Office',                     emoji: '💼', phrase: true,  vocab: false, level: 'B1', order: 35 },
    { id: 'politica',               label: 'Política',                   labelEn: 'Politics',                   emoji: '🏛️', phrase: true,  vocab: false, level: 'B1', order: 38 },
    { id: 'technology',             label: 'Tecnología',                 labelEn: 'Technology',                 emoji: '💻', phrase: true,  vocab: true, level: 'B1', order: 34 },
    { id: 'gym',                    label: 'Gimnasio',                   labelEn: 'Gym',                        emoji: '💪', phrase: true,  vocab: true, level: 'B1', order: 37 },
    { id: 'theater',                label: 'Teatro',                     labelEn: 'Theater',                    emoji: '🎭', phrase: true,  vocab: true, level: 'B1', order: 39 },
    { id: 'accountability',         label: 'Contabilidad',               labelEn: 'Accounting',                 emoji: '📊', phrase: true,  vocab: true, level: 'B2', order: 40 },
