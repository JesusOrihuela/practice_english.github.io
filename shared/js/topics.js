...
const AppTopics = (() => {
  ...
  const _DEFAULT_RECORDS = [
    ...
    { id: 'family',                 label: 'Familia',                    labelEn: 'Family',                     emoji: '👪', phrase: true,  vocab: true, level: 'A1', order: 6 },
    { id: 'emociones',              label: 'Emociones',                  labelEn: 'Emotions',                   emoji: '😊', phrase: true,  vocab: true, level: 'A1', order: 7 },
    ...
    { id: 'kitchen',                label: 'Cocina',                     labelEn: 'Kitchen',                    emoji: '🍳', phrase: true,  vocab: true, level: 'A2', order: 22 },
    { id: 'transportation',         label: 'Transporte',                 labelEn: 'Transportation',             emoji: '🚌', phrase: true,  vocab: true, level: 'A2', order: 23 },
    { id: 'airport',                label: 'Aeropuerto',                 labelEn: 'Airport',                    emoji: '✈️', phrase: true,  vocab: true, level: 'A2', order: 27 },
    { id: 'accommodation',          label: 'Alojamiento',                labelEn: 'Accommodation',              emoji: '🏨', phrase: true,  vocab: true, level: 'A2', order: 28 },
    { id: 'movies',                 label: 'Películas & Series',         labelEn: 'Movies & Series',            emoji: '🎬', phrase: true,  vocab: true, level: 'A2', order: 33 },
    { id: 'music',                  label: 'Música',                     labelEn: 'Music',                      emoji: '🎵', phrase: true,  vocab: true, level: 'A2', order: 34 },
    { id: 'museums',                label: 'Museos & Arte',              labelEn: 'Museums & Art',              emoji: '🖼️', phrase: true,  vocab: true, level: 'A2', order: 35 },
