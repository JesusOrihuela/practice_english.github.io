...
const AppTopics = (() => {
  ...
  const _DEFAULT_RECORDS = [
    { id: 'greetings',              label: 'Saludos',                    labelEn: 'Greetings',                  emoji: '👋', phrase: true,  vocab: true, vocabOrder: 5, level: 'A1', order: 1 },
    { id: 'personal_info',          label: 'Información Personal',       labelEn: 'Personal Information',       emoji: '🪪', phrase: true,  vocab: false, level: 'A1', order: 3 },
    { id: 'family',                 label: 'Familia',                    labelEn: 'Family',                     emoji: '👪', phrase: true,  vocab: true, vocabOrder: 6, level: 'A1', order: 6 },
    { id: 'emociones',              label: 'Emociones',                  labelEn: 'Emotions',                   emoji: '😊', phrase: true,  vocab: true, vocabOrder: 7, level: 'A1', order: 7 },
    ...
    { id: 'restaurant',             label: 'Restaurante',                labelEn: 'Restaurant',                 emoji: '🍽️', phrase: true,  vocab: true, vocabOrder: 13, level: 'A1', order: 10 },
    ...
    { id: 'health',                 label: 'Salud',                      labelEn: 'Health',                     emoji: '🩺', phrase: true,  vocab: true, vocabOrder: 12, level: 'A2', order: 19 },
    { id: 'cuerpo',                 label: 'Cuerpo',                     labelEn: 'Body',                       emoji: '🦵', phrase: true,  vocab: false, level: 'A2', order: 20 },
    { id: 'supermarket',            label: 'Supermercado',               labelEn: 'Supermarket',                emoji: '🛒', phrase: true,  vocab: true, vocabOrder: 14, level: 'A2', order: 21 },
    { id: 'kitchen',                label: 'Cocina',                     labelEn: 'Kitchen',                    emoji: '🍳', phrase: true,  vocab: true, vocabOrder: 15, level: 'A2', order: 22 },
    { id: 'transportation',         label: 'Transporte',                 labelEn: 'Transportation',             emoji: '🚌', phrase: true,  vocab: true, vocabOrder: 16, level: 'A2', order: 23 },
    { id: 'airport',                label: 'Aeropuerto',                 labelEn: 'Airport',                    emoji: '✈️', phrase: true,  vocab: true, vocabOrder: 27, level: 'A2', order: 27 },
    { id: 'accommodation',          label: 'Alojamiento',                labelEn: 'Accommodation',              emoji: '🏨', phrase: true,  vocab: true, vocabOrder: 28, level: 'A2', order: 28 },
    { id: 'movies',                 label: 'Películas & Series',         labelEn: 'Movies & Series',            emoji: '🎬', phrase: true,  vocab: true, vocabOrder: 23, level: 'A2', order: 33 },
    { id: 'music',                  label: 'Música',                     labelEn: 'Music',                      emoji: '🎵', phrase: true,  vocab: true, vocabOrder: 22, level: 'A2', order: 34 },
    { id: 'museums',                label: 'Museos & Arte',              labelEn: 'Museums & Art',              emoji: '🖼️', phrase: true,  vocab: true, vocabOrder: 24, level: 'A2', order: 35 },
    ...
    { id: 'gym',                    label: 'Gimnasio',                   labelEn: 'Gym',                        emoji: '💪', phrase: true,  vocab: true, vocabOrder: 26, level: 'B1', order: 41 },
    { id: 'theater',                label: 'Teatro',                     labelEn: 'Theater',                    emoji: '🎭', phrase: true,  vocab: true, vocabOrder: 25, level: 'B1', order: 43 },
    { id: 'accountability',         label: 'Contabilidad',               labelEn: 'Accounting',                 emoji: '📊', phrase: true,  vocab: true, vocabOrder: 36, level: 'B2', order: 44 },
    { id: 'general',             label: 'Conceptos',            labelEn: 'Concepts',                emoji: '💡', phrase: false, vocab: true, vocabOrder: 17 },
    { id: 'verbos_basicos',      label: 'Verbos Básicos',       labelEn: 'Basic Verbs',             emoji: '🏃', phrase: false, vocab: true, vocabOrder: 0 },
    { id: 'verbos_avanzados',    label: 'Verbos Avanzados',     labelEn: 'Advanced Verbs',          emoji: '⚡', phrase: false, vocab: true, vocabOrder: 33 },
    { id: 'adjetivos_basicos',   label: 'Adjetivos Básicos',    labelEn: 'Basic Adjectives',        emoji: '🔤', phrase: false, vocab: true, vocabOrder: 1 },
    { id: 'adjetivos_avanzados', label: 'Adjetivos Avanzados',  labelEn: 'Advanced Adjectives',     emoji: '🔠', phrase: false, vocab: true, vocabOrder: 34 },
    { id: 'colores',             label: 'Colores',              labelEn: 'Colors',                  emoji: '🎨', phrase: false, vocab: true, vocabOrder: 2 },
    { id: 'naturaleza',          label: 'Naturaleza',           labelEn: 'Nature',                  emoji: '🌳', phrase: false, vocab: true, vocabOrder: 10 },
    { id: 'tiempo',              label: 'Tiempo',               labelEn: 'Time',                    emoji: '⏰', phrase: false, vocab: true, vocabOrder: 4 },
    { id: 'lugares',             label: 'Lugares',              labelEn: 'Places',                  emoji: '📍', phrase: false, vocab: true, vocabOrder: 9 },
    { id: 'cantidad',            label: 'Cantidad y Medida',    labelEn: 'Quantity & Measure',      emoji: '🔢', phrase: false, vocab: true, vocabOrder: 3 },
    { id: 'juegos',              label: 'Juegos y Ocio',        labelEn: 'Games & Leisure',         emoji: '🎲', phrase: false, vocab: true, vocabOrder: 21 },
    { id: 'ropa',                label: 'Ropa y Moda',          labelEn: 'Clothing & Fashion',      emoji: '👕', phrase: false, vocab: true, vocabOrder: 11 },
    { id: 'lengua',              label: 'Lengua y Comunicación',labelEn: 'Language & Communication',emoji: '🗣️', phrase: false, vocab: true, vocabOrder: 20 },
    { id: 'sociedad_politica',   label: 'Sociedad y Política',  labelEn: 'Society & Politics',      emoji: '🏛️', phrase: false, vocab: true, vocabOrder: 32 },
    { id: 'trabajo',             label: 'Trabajo y Economía',   labelEn: 'Work & Economy',          emoji: '💼', phrase: false, vocab: true, vocabOrder: 19 },
    { id: 'educacion',           label: 'Educación',            labelEn: 'Education',               emoji: '🎓', phrase: false, vocab: true, vocabOrder: 18 },
    { id: 'objetos',            label: 'Objetos y cosas',      labelEn: 'Objects & Things',        emoji: '📦', phrase: false, vocab: true, vocabOrder: 8 },
    { id: 'dispositivos',          label: 'Dispositivos',         labelEn: 'Devices',                 emoji: '📱', phrase: false, vocab: true, vocabOrder: 29 },
    { id: 'internet_conectividad', label: 'Internet y Conexión',  labelEn: 'Internet & Connectivity', emoji: '🌐', phrase: false, vocab: true, vocabOrder: 30 },
    { id: 'software_apps',         label: 'Software y Apps',      labelEn: 'Software & Apps',         emoji: '🖥️', phrase: false, vocab: true, vocabOrder: 31 },
